			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarsFurni">
					<ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
						...
						<li class="nav-item active"><a class="nav-link" href="querymange.php">Querys Management</a></li>
...
if (mysqli_num_rows($result)>0) {
    ...
    while ($rows = mysqli_fetch_assoc($result) ) {
        ...
        <tr class=''>
            ...
            <td>
                <a name='' id='' class='btn btn-warning' href='editquery.php?id={$rows['id']}' role='button'>Replay</a>
                <a name='' id='' class='btn btn-danger' href='qdelete.php?id={$rows['id']}' role='button'>Delete</a>
            </td>
